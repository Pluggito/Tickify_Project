...
export default function Navbar() {
  ...
  return (
    <nav>
      ...
      <div>{userLoggedIn ? <p>Logged in as {currentUser.email} Email Verified? <input type="checkbox" checked={emailVerified} readOnly/> </p> : ""}</div>
      ...
      <ul>
        ...
        <li>
          <Link to="/discovers" className="links">
            Discover
          </Link>
        </li>
        <li>
